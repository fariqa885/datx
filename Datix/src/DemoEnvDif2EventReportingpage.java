...
////////////////////////////////////*Setting up Mvn pjt  https://www.youtube.com/watch?v=YyB2NGV69xE  
...
//    	 for(int i=1; i<=sheet.getLastRowNum(); i++){
    ...
    protected WebDriver driver;
        @Test//(priority=1)
        public void DIF1_FilloutNonLogin () throws InterruptedException {	 
        System.out.println("DIF1_FilloutNonLogin");
